...
function Profile(props) {
  ...
  return (
    <div className='bg-background w-[30vw] min-w-[350px]'>
        <div className="bg-[#4A90E2] text-white py-4 text-lg px-4 flex items-center gap-6">
        ...
        <div className="flex flex-col items-center justify-center gap-4 mt-4">
          ...
          <button onClick={handleLogout}
              className='text-white px-4 py-3 rounded bg-primary hover:bg-primary-dense'>Logout</button>
        </div>
    </div>
  )
}
